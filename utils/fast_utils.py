...
def compute_gaussian_score_fastgs(camlist, gaussians, dataset, opt, pipe, bg, DENSIFY = False, cam_rot_delta=None, cam_trans_delta=None):
...
def compute_gaussian_score_scaffold(camlist, gaussians, pipe, bg, args, DENSIFY = False):
