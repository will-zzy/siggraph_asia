...
def do_scalecano_test_with_custom_data(
    ...
    model_dir = os.path.dirname(show_dir) + "/sparse/0"
    ...
    for image_id, image in tqdm(images.items()):
        ...
        os.makedirs(os.path.dirname(img_path).replace("images", "mono_depths"), exist_ok=True)
        os.makedirs(os.path.dirname(img_path).replace("images", "mono_normals"), exist_ok=True)
        ...
        depth_save_dir = os.path.dirname(img_path).replace("images", "mono_depths")
