...
distributed = False
load_from = '/root/engineer/copy/siggraph_asia/metric3D/weight/metric_depth_vit_giant2_800k.pth'
log_file = './show_dirs/vit.raft5.giant2/20251118_080628/20251118_080628.log'
max_value = 200
mldb_info = dict(
    NYU=dict(
        data_root='nyu',
...
model = dict(
    ...
    decode_head=dict(
        ...
        use_cls_token=True),
    type='DensePredModel')
show_dir = './show_dirs/vit.raft5.giant2/20251118_080628'
test_metrics = [
    'abs_rel',
    'rmse',
    'silog',
